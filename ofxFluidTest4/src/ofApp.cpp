...
void ofApp::draw()
{
    ...
    if(isStatA)
    {
        ...
        ofDrawBitmapString("rad: " + ofToString(rad), width * 0.71, height * 0.77);
        ofDrawBitmapString("temp: " + ofToString(temp), width * 0.71, height * 0.79);
        ofDrawBitmapString("den: " + ofToString(den), width * 0.71, height * 0.81);
        ofDrawBitmapString("pos.x: " + ofToString(pos.x), width * 0.71, height * 0.83);
        ofDrawBitmapString("dir.x: " + ofToString(dir.x), width * 0.71, height * 0.85);
        ofDrawBitmapString("grav.y: " + ofToString(grav.y), width * 0.71, height * 0.87);
